...
const NavBarDropDown = ({
  ...
  const downloadFile = () => {
    const data = new Blob([JSON.stringify(climbsArrayforSearch, null, 2)], {
    ...
    <div>
      ...
      >
        <svg
          ...
          width="50"
          height="50"
          fill={filterToggle ? "#048c7f" : "currentColor"}
        ...
        >
          <ListGroup>
            <ListGroup.Item
              ...
              style={{
                backgroundColor:
                  hoveredIndex === "Docs" ? "Whitesmoke" : "white",
                cursor: "pointer",
            ...
            <ListGroup.Item
              ...
              style={{
                backgroundColor:
                  hoveredIndex === "Actions" ? "Whitesmoke" : "white",
                cursor: "pointer",
                fontFamily: "Comic Sans MS",
                fontSize: "18px",
              }}
          ...
          <ListGroup>
            {docs.map((item) => (
              <ListGroup.Item
                ...
                style={{
                  backgroundColor:
                    hoveredIndex === item ? "Whitesmoke" : "white",
                  cursor: "pointer",
                  fontFamily: "Comic Sans MS",
                  fontSize: "18px",
                }}
