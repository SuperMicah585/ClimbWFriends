...
import { convertData } from "../functions/data_parser";
    ...
    if (
      ...
      try {
        ...
        const fetchResponse = await fetch(
          `https://phelpsm4.pythonanywhere.com/scrapeclimbs?mpURL=${encodeURIComponent(mpURL)}&name=${encodeURIComponent(name)}`,
        );
        ...
        if (!fetchResponse.ok) {
          ...
          const updatedColorDic = {
            ...colorDic,
            [name]: bootstrapColors[bootstrapIndex % 9],
          };
  ...
  const mpInput = (
    <Form>
      <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
        <Form.Label style={{ marginTop: "5px", fontFamily: "Comic Sans MS" }}>
    ...
    >
      ...
      >
        <Modal.Header>
          ...
          >
            Add Climbs from Mountain Project
          </Modal.Title>
        </Modal.Header>
        ...
        */}
            ...
            <div style={{ marginLeft: "10px", width: "450px" }}>
              <Form>
                <Form.Group controlId="formFile" className="mb-3">
                  <Form.Label
                    style={{ marginTop: "5px", fontFamily: "Comic Sans MS" }}
                  >
                    Upload JSON file
                  </Form.Label>
                  <Form.Control
                    isInvalid={errorAlertUpload}
                    type="file"
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={radioValue == 1 ? addOnClick : handleSubmit}
          >
